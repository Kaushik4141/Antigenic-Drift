...
import { Camera, ArrowUp, Twitter, Linkedin, Youtube, Instagram } from 'lucide-react';
...
const Footer: React.FC = () => {
  useEffect(() => {
    ...
    if (footerInner) {
      footerInner.addEventListener('mouseenter', () => {
      ...
      footerInner.addEventListener('mouseleave', () => {
        gsap.to('.footer-inner', {
      ...
      <div className="footer-inner relative overflow-hidden w-[var(--box-width)] p-[10px] pb-[15px] md:p-[20px] flex flex-col items-center gap-[10px] rounded-[40px]"
        ...
        <div className="footer-top w-[95%] lg:w-full flex flex-col items-center gap-[30px]">
          ...
          <div className="w-full flex flex-col items-center p-[30px] md:px-[58px] md:py-[47px] border-[1px] border-solid border-[#ffffff4d] rounded-[40px] bg-[#ffffff0a]">
            ...
            <button className="syne text-[16px] md:text-[17px] lg:text-[20px] leading-[1em] font-bold text-white border-[1px] border-solid border-[#fff] rounded-[50px] w-full md:w-[651px] flex flex-row items-center justify-center gap-[5px] transition-all duration-500 hover:gap-[350px]">
